...
function LoadingIcon() {
    return (
        //downloaded from https://www.svgrepo.com/svg/491270/loading-spinner
        <svg className="loading" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
